...
export function ElegantCTA({ onPrimary, onSecondary }: ElegantCTAProps) {
  return (
    <div className="relative overflow-hidden rounded-2xl border border-border bg-card/80 p-6 sm:p-8 shadow-xl">
      ...
      <div className="relative z-10 flex flex-col items-center gap-6">
        <div className="flex items-center gap-3">
          <Sparkles className="w-5 h-5 sm:w-6 sm:h-6 text-primary twinkle-animation" />
          <h3 className="text-xl sm:text-2xl md:text-3xl font-script text-primary">With heartfelt gratitude</h3>
        </div>
        <p className="text-muted-foreground text-center max-w-prose text-sm sm:text-base">
